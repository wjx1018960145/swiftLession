...
extension UIDevice: JXPOPCompatible {}
// 这里只指屏幕类型
...
// MARK: - 一、基本的扩展
public extension JXPOP where Base: UIDevice {
    ...
    static func screenType() -> UIDeviceScreenType {
        let modelName = Base.jx.modelName
    ...
    static func isIphone5Screen() -> Bool {
        if Base.jx.screenType() == .IPHONE_5 {
            return true
        }
        return false
    }
    ...
    static func isIphone6Screen() -> Bool {
        if Base.jx.screenType() == .IPHONE_6 {
            return true
        }
        return false
    }
    ...
    static func isIphoneXScreen() -> Bool {
        if Base.jx.screenType() == .IPHONE_X || Base.jx.screenType() == .IPHONE_XS || Base.jx.screenType() == .IPHONE_XR || Base.jx.screenType() == .IPHONE_XS_Max ||  Base.jx.screenType() == .IPHONE_11 ||  Base.jx.screenType() == .IPHONE_11_PRO ||  Base.jx.screenType() == .IPHONE_11_PRO_MAX {
            return true
        }
        return false
    }
    ...
    static func isIphoneXSScreen() -> Bool {
        if Base.jx.screenType() == .IPHONE_XS || Base.jx.screenType() == .IPHONE_XR || Base.jx.screenType() == .IPHONE_XS_Max {
            return true
        }
        return false
    }
...
public extension JXPOP where Base: UIDevice {
    ...
    static var isJailbroken: Bool {
        ...
        let path = String(format: "/private/%@", String.jx.stringWithUUID() ?? "")
        do {
