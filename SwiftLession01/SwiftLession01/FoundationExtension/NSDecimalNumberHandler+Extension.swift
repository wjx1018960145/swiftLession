 ...
 */
extension NSDecimalNumberHandler: JXPOPCompatible {}
...
// MARK: - 一、基本的扩展
public extension JXPOP where Base: NSDecimalNumberHandler {
    ...
    static func isDivisible(value1: Any, value2: Any) -> Bool {
        ...
        let valueArray = value.jx.separatedByString(with: ".")
        // 没有小数代表是整除
