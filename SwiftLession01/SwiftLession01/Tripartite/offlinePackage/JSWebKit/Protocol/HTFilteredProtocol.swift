...
class HTFilteredProtocol: URLProtocol {
    ...
    class func startMonitor() {
        let sessionConfiguration = HTSessionConfiguration.defaultCenter()
        URLProtocol.registerClass(HTFilteredProtocol.self)
...
extension HTFilteredProtocol: URLSessionDelegate,URLSessionDataDelegate{
