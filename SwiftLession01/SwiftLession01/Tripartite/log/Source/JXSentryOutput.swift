...
open class JXSentryOutput: JXLogObject {
    ...
    public init(sentryKey: String, sentryURL: URL, userId: String? = nil, delegate: JXLogOutputDelegate? = nil) {
