...
extension DownLoadHelper {
    ...
    func resume() {
        ...
        downLoadRequest = AF.download(resumingWith: resuData, to: destination)
            /// 如果需要对请求头部做处理（一般防盗链）
...
extension DownLoadHelper {
    ...
    func downLoadIndex(_ index: Int) {
        ...
        downLoadRequest =  AF.download(tsModel.tsUrl, method: httpMethod, parameters: nil, encoding: URLEncoding.default, headers: htttpHeader, to: destination)
            /// 如果需要对请求头部做处理（一般防盗链）
