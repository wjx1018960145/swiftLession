...
class M3u8Parser: NSObject {
    ...
    /// 用于解析和下载的网络请求头
    var parseHtttpHeader: HTTPHeaders?
    /// 请求方式
...
//    let manager = AF.Session.default
    ...
    func parseFirstLayerM3u8(_ url: String) {
        ...
        AF.request(url, method: .get, parameters: nil, encoding: URLEncoding.default, headers: parseHtttpHeader).responseData { (response) in
    ...
    func parseDepthM3u8() {
        ...
        AF.request(depthUrl, method: httpMethod, parameters: nil, encoding: URLEncoding.default, headers: parseHtttpHeader).responseData { (response) in
...
private extension M3u8Parser {
    ...
    func downloadURIkey(_ keyUrlStr: String) {
        AF.request(keyUrlStr, method: .get, parameters: nil, encoding: URLEncoding.default, headers: parseHtttpHeader).responseData { (response) in
