...
class TSManager: NSObject {
    ...
    /// 解析url
    open func parse(_ uriKey: String? = nil, _ httpHeader:HTTPHeaders? = nil, _ method: HTTPMethod? = .get) {
    ...
    /// 下载
    open func download(_ uriKey: String? = nil, _ httpHeader:HTTPHeaders? = nil, _ method: HTTPMethod? = .get) {
        m3u8Parser.httpMethod = method ?? .get
        m3u8Parser.parseHtttpHeader = httpHeader
