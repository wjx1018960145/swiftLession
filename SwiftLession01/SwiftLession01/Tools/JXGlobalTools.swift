...
public struct JXGlobalTools {
    ...
    public static func compareVersion(version: String) -> Bool {
        ...
        // 2、当前版本的版本号获取 三位Int值
        let currentVersion = Bundle.jx.appVersion
...
private extension JXGlobalTools {
    ...
    static func appVersion(version: String) -> (isSuccess: Bool, versions: [Int]) {
        ...
        guard let versionValue1 = versionString1.jx.toInt(), let versionValue2 = versionString2.jx.toInt(), let versionValue3 = versionString3.jx.toInt() else {
            return (false, [])
        }
