...
class UITextViewExtensionViewController: TestBaseViewController {
...
extension UITextViewExtensionViewController: UITextViewDelegate {
    ...
    // MARK: 2.2、转换特殊符号标签字段
    @objc func test22() {
        let textView = UITextView(frame: CGRect(x: 16, y: 100, width: jx_kScreenW - 32, height: 200))
    ...
    @objc func test21() {
        ...
        textView.text = ""
        textView.isEditable = false
        textView.jx.appendLinkString(string: "欢迎使用jxSwiftExtension!\n", font: font)
        textView.jx.appendLinkString(string: "(1）", font: font)
        textView.jx.appendLinkString(string: "查看详细说明", font: font, withURLString: "about://www.baidu.com")
        textView.jx.appendLinkString(string: "\n(2）", font: font)
        textView.jx.appendLinkString(string: "问题反馈", font: font, withURLString: "feedback://www.baidu.com")
        self.view.addSubview(textView)
...
extension UITextViewExtensionViewController {
    ...
    @objc func test14() {
        ...
        self.view.addSubview(textView)
        print("设置默认文本的CGSize(width: 20, height: 20)")
        JXAsyncs.asyncDelay(10, {
        }) {
            textView.removeFromSuperview()
        }
