...
class UITextFieldExtensionViewController: TestBaseViewController {
...
extension UITextFieldExtensionViewController {
    ...
    @objc func test11() {
        ...
        textFiled.backgroundColor = .randomColor
        textFiled.jx.addLeftTextPadding(20)
        self.view.addSubview(textFiled)
        JXAsyncs.asyncDelay(3) {
        } _: {
            textFiled.removeFromSuperview()
    ...
    @objc func test12() {
        ...
        let textFiled = UITextField(frame: CGRect(x: 100, y: 100, width: 200, height: 40))
        textFiled.backgroundColor = .randomColor
        textFiled.jx.addLeftIcon(UIImage(named: "ironman"), leftViewFrame: CGRect(x: 20, y: 20, width: 30, height: 30), imageSize: CGSize(width: 20, height: 20))
        self.view.addSubview(textFiled)
        JXAsyncs.asyncDelay(300) {
        } _: {
            textFiled.removeFromSuperview()
    ...
    @objc func test13() {
        ...
        JXAsyncs.asyncDelay(5) {
            ...
            print("是否都是数字", "结果是：\(textFiled.jx.validateDigits())")
            textFiled.removeFromSuperview()
        }
    }
    ...
    @objc func test14() {
        ...
        textFiled.jx.setPlaceholderAttribute(font: UIFont.systemFont(ofSize: 16), color: UIColor.randomColor)
        self.view.addSubview(textFiled)
        JXAsyncs.asyncDelay(1000) {
        } _: {
            textFiled.removeFromSuperview()
        }
    }
