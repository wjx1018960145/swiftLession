...
// MARK: - 一、基本的扩展
public enum JXViewGradientDirection {
    /// 水平从左到右
    case horizontal
    ///  垂直从上到下
    case vertical
...
public extension JXPOP where Base: CAGradientLayer {
    ...
    func gradientLayer(_ direction: JXViewGradientDirection = .horizontal, _ gradientColors: [Any], _ gradientLocations: [NSNumber]? = nil) -> CAGradientLayer {
