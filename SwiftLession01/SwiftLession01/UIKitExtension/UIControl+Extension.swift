...
public extension JXPOP where Base: UIControl {
...
fileprivate extension UIControl  {
    ...
    private var hitTime: Double? {
        get { return jx_getAssociatedObject(self, &hitTimerKey) }
        set { jx_setRetainedAssociatedObject(self, &hitTimerKey, newValue, .OBJC_ASSOCIATION_ASSIGN) }
    }
    ...
    @objc func c_preventDoubleHit(_ base: UIControl)  {
        ...
        JXAsyncs.asyncDelay(hitTime ?? 1.0) {
        } _: {
